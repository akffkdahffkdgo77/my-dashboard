...
export default function Projects() {
    ...
    return (
        <div className="min-w-[300px] bg-black rounded-md pt-5 mt-5">
            <h4 className="font-mono text-[14px] font-bold text-white mx-5 flex justify-between">
                Projects
                <span className="text-[12px] text-black bg-[#ffffff] rounded-md py-[2.5px] px-[5px]">2022.01 ~ 2022.12</span>
            </h4>
